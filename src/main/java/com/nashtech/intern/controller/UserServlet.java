...
public class UserServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			case "/modify":
				...
				break;
			case "/lib":
				listBooksByUser(request,response);
				break;
			default:
	...
	private void listBooksByUser(HttpServletRequest request, HttpServletResponse response)
			throws SQLException, IOException, ServletException {
		long userId = Long.parseLong(request.getParameter("id"));
		List<Book> listBooksByUser = bookDAO.getBooksByUser(userId);
		request.setAttribute("listBooksByUser", listBooksByUser);
		RequestDispatcher dispatcher = request.getRequestDispatcher("user-lib.jsp");
		dispatcher.forward(request, response);
	}
}
